(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("tween.js"), require("react-portal"));
	else if(typeof define === 'function' && define.amd)
		define(["react", "tween.js", "react-portal"], factory);
	else if(typeof exports === 'object')
		exports["react-image-slideshow"] = factory(require("react"), require("tween.js"), require("react-portal"));
	else
		root["react-image-slideshow"] = factory(root["react"], root["tween.js"], root["react-portal"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appStyle = __webpack_require__(9);
	...
	var Slideshow = function (_React$Component) {
	    ...
	    function Slideshow(props) {
	        ...
	        _this.handleImageOnLoaded = _this.handleImageOnLoaded.bind(_this);
	    ...
	    _createClass(Slideshow, [{
	        ...
	        value: function calAllImageSize() {
	            ...
	            this.props.imgs ? this.props.imgs.map(function (imageData, urlIndex) {
	                _this3.calImageSize(imageData.url, function (size) {
	                    ...
	                    _this3.setState({ imageSize: imgSizeData });
	                });
	            }) : null;
	        }
	    }, {
	        ...
	        key: 'handleImageOnLoaded',
	        value: function handleImageOnLoaded(e) {
	                ...
	                _react2.default.createElement(
	                    ...
	                    this.props.switchButton ? _react2.default.createElement(
	                        ...
	                        { className: _app2.default.toPreviousButton, onClickCapture: function onClickCapture() {
	                                return _this5.handleImageSliderToPrevious();
	                            }, id: 'toPrevButton' },
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        this.props.imgs && this.state.imageSize ? this.props.imgs.map(function (imageData, index) {
	                            var imageWrapperStyle = index == _this5.state.nowImage ? _appStyle2.default.imageWrapperShowStyle : _appStyle2.default.imageWrapperHideStyle;
	                            var imageMovePos = index == _this5.state.nowImage ? _this5.state.imageMovePos : null;
	                            var imageUrl = _this5.props.lazyLoad ? index == _this5.state.nowImage ? imageData.url : _this5.state.imageSize[index].width == 0 ? '' : imageData.url : imageData.url;
	                            var actionStyle = {
	                                top: _this5.window.innerHeight / 2 - _this5.state.imageSize[index].height / 2,
	                                right: _this5.window.innerWidth / 2 - _this5.state.imageSize[index].width / 2 - 48,
	                                display: _this5.state.showAction ? 'block' : 'none'
	                            };
	                            var loadingStyle = { display: _this5.props.loading ? 'block' : 'none' };
	                            return _react2.default.createElement(
	                                'div',
	                                ...
	                                _react2.default.createElement('div', {
	                                    ...
	                                    onMouseOver: _this5.handleImageCloserHover
	                                }),
	                                _react2.default.createElement(
	                                    'div',
	                                    ...
	                                    _react2.default.createElement('img', {
	                                        ...
	                                        style: Object.assign({}, _this5.state.imageSize[index], _this5.state.imageSizeAnimate),
	                                        onSelect: _this5.preventSelect,
	                                        onLoad: _this5.handleImageOnLoaded
	                                    }),
	                                    _react2.default.createElement(
	                                        'div',
	                                        {
	                                        ...
	                                        _this5.props.zoomButton ? _react2.default.createElement(
	                                            'a',
	                                            { className: _app2.default.imageZoom, onClickCapture: function onClickCapture() {
	                                                    return _this5.handleImageZoom(index);
	                                                } },
	                                            _react2.default.createElement(
	                                                'svg',
	                                        ...
	                                        _this5.props.downloadButton ? _react2.default.createElement(
	                                            'a',
	                                ...
	                                _react2.default.createElement(
	                                    'div',
	                                    { className: _app2.default.imageSwitch, style: _this5.state.imageSize[index] },
	                                    _react2.default.createElement('div', {
	                                    ...
	                                    _react2.default.createElement('div', {
	                                        ...
	                                        onMouseOver: _this5.handleImageSliderToPreviousHover
	                                    }),
	                                    _react2.default.createElement('div', {
	                                        className: _app2.default.rightSwitch,
	                                        onClickCapture: function onClickCapture() {
	                                            return _this5.handleImageSliderToNext();
	                                        },
	                                        onMouseOver: _this5.handleImageSliderToNextHover
	                                    })
	                                )
	                            );
	                        }) : null,
